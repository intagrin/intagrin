...
4. **Thermodynamic HUD**: See your live token burn rate and USD costs directly in the UI during playground test sessions — a compact badge in the session header (never overlapping the transcript below it); click it to expand the full detail card, including the context-window usage bar.
